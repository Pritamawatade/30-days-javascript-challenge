...
function linearSearch(array, target) {
    ...
    console.log('Targetted element not found: ', target);
...
console.log(" char is reapeated ",charcount(str,'a'));
...
console.log("Length of longest substring without repeating characters: ", longestSubstring("abcabcbb")); // 3

// write the functiton to rotate the array by k positions and log the roated array
